          ...
          <ul class="nav">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                    <a class="dropdown-item" href="{{ route('monthlyReport.index') }}">Monthly Report</a>
                </div>
            </li>
        ...
        <footer class="footer">
          <div class="container-fluid">
            ...
            <div class="copyright text-center">
              ...
              <a href="http://intezie.com" target="_blank">Intezie Limited</a>.
              <p>Design &amp; Developed By <a class="intezie" href="http://intezie.com" target="_blank"> Intezie Limited</a> | Powered By Creativity &amp; Technology</p>
            </div>
          </div>
        </footer>
      </div>
